...
# ✅ إعدادات تيليجرام
TOKEN = '7342989520:AAEwZ9VmdUgGZk1C8iAuD44J9y5nJQ7A4fc'
CHAT_ID = '5389040264'
bot = Bot(token=TOKEN)
...
def set_bot_commands(app):
    commands = [
        BotCommand("start", "بدء البوت وشرح الأوامر"),
        BotCommand("help", "عرض المساعدة"),
        BotCommand("analyze", "تحليل عملة يدوياً"),
        BotCommand("scan", "فحص السوق للفرص"),
        BotCommand("top", "أكثر العملات تحركًا"),
        BotCommand("silent_moves", "سيولة بدون تحرك سعري"),
        BotCommand("watchlist", "تحليل قائمتك الخاصة"),
